...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        OfKeyword = 154,
        QualifiedName = 155,
        ComputedPropertyName = 156,
        TypeParameter = 157,
        Parameter = 158,
        Decorator = 159,
        PropertySignature = 160,
        PropertyDeclaration = 161,
        MethodSignature = 162,
        MethodDeclaration = 163,
        Constructor = 164,
        GetAccessor = 165,
        SetAccessor = 166,
        CallSignature = 167,
        ConstructSignature = 168,
        IndexSignature = 169,
        TypePredicate = 170,
        TypeReference = 171,
        FunctionType = 172,
        ...
        RestType = 179,
        UnionType = 180,
        IntersectionType = 181,
        ConditionalType = 182,
        InferType = 183,
        ParenthesizedType = 184,
        ThisType = 185,
        TypeOperator = 186,
        IndexedAccessType = 187,
        MappedType = 188,
        LiteralType = 189,
        ImportType = 190,
        ObjectBindingPattern = 191,
        ArrayBindingPattern = 192,
        BindingElement = 193,
        ArrayLiteralExpression = 194,
        ObjectLiteralExpression = 195,
        PropertyAccessExpression = 196,
        ElementAccessExpression = 197,
        CallExpression = 198,
        NewExpression = 199,
        TaggedTemplateExpression = 200,
        TypeAssertionExpression = 201,
        ParenthesizedExpression = 202,
        ...
        LastCompoundAssignment = 76,
        FirstReservedWord = 79,
    ...
    export enum NodeFlags {
        ...
        JSDoc = 4194304,
        JsonFile = 33554432,
        CreatedInPreprocessor = 134217728,
        BlockScoped = 3,
...
declare namespace ts {
    ...
    export function createSourceFile(fileName: string, sourceText: string, languageVersion: ScriptTarget, setParentNodes?: boolean, scriptKind?: ScriptKind, preprocessors?: Preprocessors): SourceFile;
...
declare namespace ts {
    ...
    function createLanguageServiceSourceFile(fileName: string, scriptSnapshot: IScriptSnapshot, scriptTarget: ScriptTarget, version: string, setNodeParents: boolean, options: CompilerOptions, scriptKind?: ScriptKind): SourceFile;
    function updateLanguageServiceSourceFile(sourceFile: SourceFile, scriptSnapshot: IScriptSnapshot, version: string, textChangeRange: TextChangeRange | undefined, options: CompilerOptions, aggressiveChecks?: boolean): SourceFile;
